...
const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'weixin-recall-rewrite', title: '讲过的话，换个说法再讲', desc: '个人微信召回时，客户以前听过的话题（包括销售用群发助手发过的）不再原样发，而是换一种人工确认过的讲法：卖点不变，先讲什么、怎么讲要变；没确认之前这条先不发。分五部分：发召回前系统做的三件事（附原说法与新说法对照）、怎么靠客户聊天窗口里的发送时间认出他收到过哪几次群发、新说法的六个话题和三道关、现在还差的三件事（审稿 / 给小鱼那台装 1.14.55 / 补录其他销售的群发），以及 9 月 17 日的上线记录（状态截至 2026-09-18 00:15）。' },
